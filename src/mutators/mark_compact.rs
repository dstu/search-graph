...
impl<'a, T, S, A> Collector<'a, T, S, A>
where
  T: Hash + Eq + Clone + 'a,
  S: 'a,
  A: 'a,
...
mod test {
  ...
  fn reachable_loop_ok() {
    ...
    g.add_edge("1", |_| "1_data", "11", |_| "11_data", "1_11_data");
    g.add_edge("11", |_| "11_data", "0", |_| "0_data", "11_0_data");
    g.add_edge("2", |_| "2_data", "20", |_| "20_data", "2_20_data");
    g.add_edge("2", |_| "2_data", "21", |_| "21_data", "2_21_data");
    g.add_edge("21", |_| "21_data", "210", |_| "210_data", "21_210_data");
    g.add_edge("21", |_| "21_data", "211", |_| "211_data", "21_211_data");
    g.add_edge("210", |_| "210_data", "0", |_| "0_data", "210_0_data");
    g.add_edge(
      "210",
      |_| "210_data",
      "2100",
    ...
    g.add_edge("2100", |_| "2100_data", "0", |_| "0_data", "2100_0_data");
    ...
    assert_eq!(
      ...
      vec!(
        ...
        make_vertex("21_data", vec!(EdgeId(1)), vec!(EdgeId(2), EdgeId(3))),
        make_vertex("210_data", vec!(EdgeId(2)), vec!(EdgeId(4), EdgeId(5))),
        make_vertex("211_data", vec!(EdgeId(3)), vec!()),
        make_vertex(
          "0_data",
          vec!(EdgeId(4), EdgeId(8)),
          vec!(EdgeId(6), EdgeId(7))
        ),
        make_vertex("2100_data", vec!(EdgeId(5)), vec!(EdgeId(8))),
        make_vertex("00_data", vec!(EdgeId(6)), vec!()),
        make_vertex("01_data", vec!(EdgeId(7)), vec!()),
      )
    );
  ...
  fn parallel_edges_ok() {
    ...
    assert_eq!(
      g.vertices,
      vec!(
        make_vertex("0_data", vec!(), vec!(EdgeId(0), EdgeId(1), EdgeId(2))),
    ...
    assert_eq!(
      g.arcs,
      vec!(
        make_arc("0_00_data_1", VertexId(0), VertexId(1)),
  ...
  fn cycles_ok() {
    ...
    assert_eq!(
      g.arcs,
      vec!(
        make_arc("00_00_data", VertexId(0), VertexId(0)),
